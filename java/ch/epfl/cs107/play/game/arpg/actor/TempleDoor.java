 ...
 */
public class TempleDoor extends Door {
    private RPGSprite openDoor;
    private RPGSprite closedDoor;

    /**
     * Default TempleDoor constructor, same as door but with default  signal (OFF/FALSE)
     ...
     */
    public TempleDoor(String destination, DiscreteCoordinates otherSideCoordinates, Area area, Orientation orientation, DiscreteCoordinates position, DiscreteCoordinates... otherCell) {
        super(destination, otherSideCoordinates, Logic.FALSE, area, orientation, position, otherCell);
        openDoor = new RPGSprite ("zelda/cave.open", 1, 1, this , new RegionOfInterest(0 , 0, 16, 16));
        closedDoor = new RPGSprite ("zelda/cave.close", 1, 1, this , new RegionOfInterest(0 , 0, 16, 16));
    }
